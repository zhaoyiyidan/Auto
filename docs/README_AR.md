...
| **🔄 حلقة PIVOT / EXTEND** | المرحلة 15 تقرر بشكل مستقل: PROCEED أو EXTEND (follow-up hypotheses) أو PIVOT (اتجاه جديد). المخرجات تُحفظ بإصدارات تلقائياً. |
...
Phase A: تحديد نطاق البحث          Phase E: تنفيذ التجارب
  ...
  2. PROBLEM_DECOMPOSE               13. EXPERIMENT_ROUTE_DECISION  ← إصلاح ذاتي

Phase B: اكتشاف الأدبيات          Phase F: التحليل والقرار
  3. SEARCH_STRATEGY                 14. RESULT_ANALYSIS    ← متعدد الوكلاء
  4. LITERATURE_COLLECT  ← API حقيقي  15. RESEARCH_DECISION  ← PIVOT / EXTEND
...
> **حلقات القرار**: يمكن للمرحلة 15 تفعيل EXTEND (→ المرحلة 8) أو PIVOT (→ المرحلة 8)، مع إصدار تلقائي للمخرجات.
...
| **F: التحليل** | تحليل متعدد الوكلاء للنتائج؛ قرار مستقل PROCEED / EXTEND / PIVOT مع المبررات |
...
| عدد دورات الإصلاح | 2.0 | 1.2 | **-40.0%** |
| إكمال مراحل خط الأنابيب | 18/19 | 19/19 | **+5.3%** |
| درجة المتانة الإجمالية (مركّبة) | 0.714 | 0.845 | **+18.3%** |

> درجة المتانة المركّبة هي متوسط مرجّح لمعدل إكمال المراحل (40%) وتقليل المحاولات (30%) وكفاءة دورات الإصلاح (30%).
